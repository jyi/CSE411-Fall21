...
public class ExtendedParserTest {
  ...
  private static CompilationUnitContext parse(final String filename)
      throws Exception {
    return ExtendedParserUtil.parse(Util.getResource(
  ...
  @Test
  public void testFailParseDec() {
    testPass("FailParseDec.java");
  }
